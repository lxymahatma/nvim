...
return {
  ...
  keys = {
    {
      "<C-a>",
      function() return dial("increment", false) end,
      desc = "Increment",
      mode = { "n", "v" },
    },
    {
      "<C-x>",
      function() return dial("decrement", false) end,
      desc = "Decrement",
      mode = { "n", "v" },
    },
    {
      "g<C-a>",
      function() return dial("increment", true) end,
      desc = "Increment",
      mode = { "n", "x" },
    },
    {
      "g<C-x>",
      function() return dial("decrement", true) end,
      desc = "Decrement",
      mode = { "n", "x" },
    },
  },
