...
---@field formatter? string | string[] | table<string, string|string[]> Formatters. `string` uses tool_name, `string[]` uses tool_name with multiple filetypes, or `table` for explicit filetype mapping.
---@field linter? string | string[] | table<string, string[]> Linters. `string` uses tool_name, `string[]` uses tool_name with multiple filetypes, or `table` for explicit filetype mapping.
---@field plugins? LazyPluginSpec | LazyPluginSpec[] Extra plugins to install. Can be a single plugin spec or a list of plugin specs.
