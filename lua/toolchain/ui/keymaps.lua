...
function Keymaps.attach(ui)
  ...
  map("n", "G", function() if ui.state:set_cursor(#ui.state.filtered_items) then ui:render() end end, opts)

  map("n", "gg", function() if ui.state:set_cursor(1) then ui:render() end end, opts)
