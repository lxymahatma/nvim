return {
  ...
  hl = function(self)
    return self.is_active and { fg = "red", bg = "surface0", bold = true }
      or {
        fg = "subtext0",
        bg = "mantle",
      }
  ...
  on_click = {
    ...
    callback = function(_, minwid, _, button) if button == "l" then vim.api.nvim_set_current_tabpage(minwid) end end,
