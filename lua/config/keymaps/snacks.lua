...
map("n", "<leader>fw", Snacks.picker.grep, { desc = "Text" })

-- Search
map("n", "<leader>sa", Snacks.picker.autocmds, { desc = "Autocmds" })
map("n", "<leader>sb", Snacks.picker.grep_buffers, { desc = "In Buffer" })
...
map("n", "<leader>sf", Snacks.picker.filetypes, { desc = "Filetypes" })
map("n", "<leader>sh", Snacks.picker.search_history, { desc = "History" })
...
map("n", "<leader>ci", Snacks.picker.lsp_incoming_calls, { desc = "Calls Incoming", lsp = { method = "callHierarchy/incomingCalls" } })
map("n", "<leader>co", Snacks.picker.lsp_outgoing_calls, { desc = "Calls Outgoing", lsp = { method = "callHierarchy/outgoingCalls" } })
