...
-- Explorer
map("n", "<leader>fe", function() Snacks.explorer.reveal() end, { desc = "File Explorer" })
...
map("n", "<leader>fw", function() Snacks.picker.grep() end, { desc = "Text" })

-- Search
map("n", "<leader>sa", function() Snacks.picker.autocmds() end, { desc = "Autocmds" })
map("n", "<leader>sb", function() Snacks.picker.grep_buffers() end, { desc = "In Buffer" })
map("n", "<leader>sc", function() Snacks.picker.ast_grep() end, { desc = "AST Grep" })
...
map("n", "<leader>sf", function() Snacks.picker.filetypes() end, { desc = "Filetypes" })
map("n", "<leader>sh", function() Snacks.picker.search_history() end, { desc = "History" })
map("n", "<leader>sH", function() Snacks.picker.highlights() end, { desc = "Highlights" })
map("n", "<leader>si", function() Snacks.picker.icons() end, { desc = "Icons" })
map("n", "<leader>sj", function() Snacks.picker.jumps() end, { desc = "Jumps" })
map("n", "<leader>sk", function() Snacks.picker.keymaps() end, { desc = "Keymaps" })
map("n", "<leader>sl", function() Snacks.picker.loclist() end, { desc = "Location List" })
map("n", "<leader>sL", function() Snacks.picker.lsp_config() end, { desc = "LSP Configurations" })
...
-- Scratch
map("n", "<leader>bs", function() Snacks.scratch.open() end, { desc = "Toggle Scratch Buffer" })
